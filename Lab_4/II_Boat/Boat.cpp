...
float angle = 25;		//Scene rotation angle
...
void drawBase()
{
	const int NPTS = 40;	//Number of vertices on the polygonal line
	...
	for (int i = 0; i < NPTS; i++)
		glVertex3f(vx[i], 0.01, vz[i]);   //An offset is added to avoid depth fighting with floor plane
	glEnd();
...
void drawSide()
{
	const int NSIDE = 21;   //Size of the array
